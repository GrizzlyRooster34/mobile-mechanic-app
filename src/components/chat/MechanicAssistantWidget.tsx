...
export const MechanicAssistantWidget: React.FC<MechanicAssistantWidgetProps> = ({
  ...
  return (
    <div className={`fixed bottom-4 left-4 sm:bottom-6 sm:left-6 w-full sm:w-[500px] h-full sm:h-[600px] max-w-lg bg-white rounded-none sm:rounded-lg shadow-xl border z-50 flex flex-col ${className}`} role="dialog" aria-labelledby="mechanic-chat-header" aria-describedby="mechanic-chat-content">
      {/* Header */}
